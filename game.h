...
public:
	...
	enum game_state_t { STATE_RED, STATE_BLUE, STATE_MOVER,STATE_MOVEB,STATE_ATTACKR,STATE_ATTACKB,STATE_CHOOSE_ATTACKMOVER, 
		STATE_CHOOSE_ATTACKMOVEB,
		STATE_INIT, STATE_LOADING,
		STATE_START_SCREEN, STATE_LAST_SCREEN
	};
